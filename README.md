...
A proposta seria de projetar um sensor para ser instalado no local onde os vinhos são armazenados para então monitorar a quantidade de luminosidade do ambiente,  
tendo em mente que a qualidade do vinho é diretamente influenciada por três fatores principais, e um deles é justamente a luminosidade.
...
Utilizamos três LEDs que seriam acendidos e sinalizando, assim, o nível de luminosidade do ambiente. Para estabelecer esta dinâmica entre os leds e a luminosidade,  
criamos a seguinte lógica de programação:  
...
### Sobre o LDR
O LDR, ou fotoresistor, vai possuir ter um sistema de captação de luz, que pode ser regulado manualmente. Com isso, é possível escolher o quanto de  
luminosidade vamos querer ao arrastar para um lado e para o outro.  
